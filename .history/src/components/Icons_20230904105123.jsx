...
const Icons = () => {
  const data = [
    ...
    { icon: <ReplyIcon sx={{ color: grey[200], fontSize: 35 }} />, count: 5782 },
  ];
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        ...
        <AddCircleRoundedIcon
          sx={{ position: "absolute", color: red[600], fontSize: 20, bottom: -10, backgroundColor: grey[100], borderRadius: "50px" }}
        />
      </IconButton>
      {data.map((item) => (
        <IconButton
